/* eslint-disable */
// Generated by Wrangler by running `wrangler types ./src/worker-configuration.d.ts` (hash: 67c39b44fc12ef9bbc13f192d3531b29)
// Runtime types generated with workerd@1.20250803.0 2025-08-10 nodejs_compat
declare namespace Cloudflare {
	interface Env {
		SLACK_BOT_TOKEN: string;
		GRID_STORAGE: DurableObjectNamespace /* GridStorage */;
		ASSETS: Fetcher;
	}
}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "SLACK_BOT_TOKEN">> {}
}
